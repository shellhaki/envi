---
title: "CLI Reference"
description: "Every envi command."
---
...
<ParamField query="--production" type="boolean">Mark this environment as production — see <a href="/concepts/access-and-permissions">Access & Permissions</a></ParamField>
...
Sends local `.env` changes up. Fails with a conflict if the remote has changed since your last pull or push — see [revisions](/concepts/projects-and-environments#revisions-and-conflict-detection).
